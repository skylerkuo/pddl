(define (problem install-multiple-wires)
  ...
  (:objects
    ...
    power_supply_1 power_supply_2 power_supply_3 power_supply_4 power_supply_5 power_supply_6 power_supply_7 power_supply_8 power_supply_9 power_supply - location
    table - workspace
  )
  (:init
    ;(arm-empty arm1)
